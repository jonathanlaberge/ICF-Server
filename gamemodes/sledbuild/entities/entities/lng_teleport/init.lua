	...
	function ENT:StartTouch( entity )
		...
		if entity:IsPlayer() and entity:InVehicle() then
			if self.AlreadyTeleported == 0 then
				...
				if Jonathan1358LibLoaded then
					net.Start("Jonathan1358.Msg.CenterBox")
						net.WriteString("[1st] " ..entity:Nick().. " First!")
						net.WriteFloat(0)
						net.WriteFloat(225)
						net.WriteFloat(0)
						net.WriteFloat(255)
			...
			elseif self.AlreadyTeleported == 1 then
				...
				if Jonathan1358LibLoaded then
					net.Start("Jonathan1358.Msg.CenterBox")
						net.WriteString("[2nd] " ..entity:Nick().. " Second!")
						net.WriteFloat(225)
						net.WriteFloat(225)
						net.WriteFloat(0)
						net.WriteFloat(255)
			...
			elseif self.AlreadyTeleported == 2 then
				...
				if Jonathan1358LibLoaded then
					net.Start("Jonathan1358.Msg.CenterBox")
						net.WriteString("[3rd] " ..entity:Nick().. " Third!")
						net.WriteFloat(225)
						net.WriteFloat(0)
						net.WriteFloat(0)
						net.WriteFloat(255)
				...
				if Jonathan1358LibLoaded then
					net.Start("Jonathan1358.Msg.CenterBox")
						net.WriteString("[" ..self.AlreadyTeleported.. "th] " ..entity:Nick())
						net.WriteFloat(225)
						net.WriteFloat(0)
						net.WriteFloat(225)
						net.WriteFloat(255)
