...
function DrawLogoBox( x, y, w, h )
	...
	surface.DrawText( "Made by G3X. Thanks to ReaperSWE, Borsty, Metroid48 and robinkooli." )
	surface.SetTextColor( 255, 255, 255, 255 )
	...
	surface.SetTextPos( xCenter + 90, yCenter + 41 )
	surface.DrawText( "This gamemode has been modified by jonathan1358 for this server. VERSION: 1.2.B" )
	surface.SetTextColor( 255, 255, 255, 255 )
	surface.SetTextPos( xCenter + 91, yCenter + 40 )
	surface.DrawText( "This gamemode has been modified by jonathan1358 for this server. VERSION: 1.2.B" )
end
