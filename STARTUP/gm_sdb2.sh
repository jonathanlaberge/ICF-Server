...
OPTS="-echo $SCREENREF -game garrysmod +ip 0.0.0.0 +hostip 192.99.35.97 +host_workshop_collection 260529082 +map slb_snowsled_v3 +gamemode sledbuild +sv_lan 0 -nohltv -port 27049 +port 27049 +clientport 27149 +sv_pure 0 +heartbeat +maxplayers 32 -authkey XXXX +servercfgfile server_sdb2.cfg"
