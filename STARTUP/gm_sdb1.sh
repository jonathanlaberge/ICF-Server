...
OPTS="-echo $SCREENREF -game garrysmod +ip 0.0.0.0 +hostip 192.99.35.97 +host_workshop_collection 260529082 +map slb_snowsled_v3 +gamemode sledbuild +sv_lan 0 -nohltv -port 27047 +port 27047 +clientport 27147 +sv_pure 0 +heartbeat +maxplayers 32 -authkey XXXX +servercfgfile server_sdb1.cfg"
