...
OPTS="-echo $SCREENREF -game garrysmod +ip 0.0.0.0 +hostip 192.99.35.97 +host_workshop_collection 286673634 +map gm_construct +gamemode hideandseek +sv_lan 0 -nohltv -port 27040 +port 27040 +clientport 27140 +sv_pure 0 +heartbeat +maxplayers 32 -authkey XXXX +servercfgfile server_hs2.cfg"
