...
function ulx.noclip( calling_ply, target_plys )
	...
	ulx.fancyLogAdmin( calling_ply, false, "#A toggles noclip on #T", affected_plys )
end
...
function ulx.spectate( calling_ply, target_ply )
	...
	local function stopSpectate( player )
		...
		ulx.fancyLogAdmin( calling_ply, false, "#A stopped spectating #T", target_ply )
	...
	ulx.fancyLogAdmin( calling_ply, false, "#A began spectating #T", target_ply )
end
