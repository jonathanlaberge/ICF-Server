...
function GB_ConvertBan(steamid, name, BanLength, Time, AdminName, AdminSteam, Reason, MAdmin, MTime)
	--Insert Ban
	local AddBanQuery = ULX_DB:query("INSERT INTO ulx_bans VALUES ('','"..steamid.."','"..GB_Escape(name).."','"..BanLength.."','"..Time.."','"..GB_Escape(AdminName).."','"..AdminSteam.."','"..GB_Escape(Reason).."','"..GB_SERVERID.."','"..MAdmin.."','"..MTime.."');");
