function JonAdvertThink() -- Print JonAdverts
	if not Initialized then -- Not initialized?
		...
		JonAdverts[4] = [[chat.AddText(Color(255,255,255),"[",Color(255,255,0),"I.C.F.",Color(0,255,255)," Adverts",Color(255,255,255),"] ",Color(255,255,255),"  You are ",Color(255,0,0),"not",Color(255,255,255)," allowed to prop / trail spam in sledbuild. Disobeying this rules may get you a ",Color(255,0,0),"ban",Color(255,255,255),".")]]
		JonAdverts[5] = [[chat.AddText(Color(255,255,255),"[",Color(255,255,0),"I.C.F.",Color(0,255,255)," Adverts",Color(255,255,255),"] ",Color(255,255,255),"  You are not allowed to spawn these kind of duplications: ",Color(155,155,255),"Snake, Gravity props, House or fort")]]
		JonAdverts[6] = [[chat.AddText(Color(255,255,255),"[",Color(255,255,0),"I.C.F.",Color(0,255,255)," Adverts",Color(255,255,255),"] ",Color(255,255,255),"  You can allow other players to control your props. To allow them, ",Color(40,200,215),"hold Q > go to Utilities Tab > NADMOD Section > Client",Color(255,255,255),". Select the player you want to share the prop with, then click ",Color(255,40,40),"apply",Color(255,255,255),".")]]
		JonAdverts[7] = [[chat.AddText(Color(255,255,255),"[",Color(255,255,0),"I.C.F.",Color(0,255,255)," Adverts",Color(255,255,255),"] ",Color(255,255,255),"  Have Discord? Feeling lonely? Need help from a staff? Look no further! Join the Official I.C.F. Discord today! ",Color(88,88,255)," http://serveri.cf/dis")]]
